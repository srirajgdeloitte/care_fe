...
export default function PatientFilterV2(props: any) {
  ...
  const [filterState, setFilterState] = useMergeState({
    ...
    last_consultation_assigned_to_mbbs_student: filter.last_consultation_assigned_to_mbbs_student || null,
  ...
  const setAssignedTo = (event: any) => {
    const { name, value } = event.target;
    const filterData: any = { ...filterState };
    console.log(name, value)
    if(value === 'Me')  {
      filterData['last_consultation_assigned_to_mbbs_student'] = currentUser.data.id
    }
    else filterData['last_consultation_assigned_to_mbbs_student'] = ''
  ...
  const applyFilter = () => {
    const {
      ...
      age_min,
      age_max,
      last_consultation_assigned_to_mbbs_student,
      last_consultation_admission_date_before,
      last_consultation_admission_date_after,
      last_consultation_discharge_date_before,
      last_consultation_discharge_date_after,
    ...
    const data = {
      ...
      last_consultation_discharge_date_after:
        ...
        moment(last_consultation_discharge_date_after).isValid()
          ...
          : "",
      last_consultation_assigned_to_mbbs_student: last_consultation_assigned_to_mbbs_student || "",
      ordering: ordering || "",
      category: category || "",
      gender: gender || "",
      disease_status:
    ...
    <div>
      ...
      <div className="w-64 flex-none mt-2">
        ...
        <SelectField
          ...
          optionValue="desc"
          value={assignedUser}
          options={[{ desc: "Select", text: "" }, ...PATIENT_FILTER_ASSIGNED_TO]}
