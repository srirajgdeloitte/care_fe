...
export const PatientManager = (props: any) => {
  ...
  const params = {
    ...
    last_consultation_assigned_to_mbbs_student: qParams.last_consultation_assigned_to_mbbs_student || undefined,
  ...
  useEffect(() => {
    ...
    dispatch(getAllPatient(params, 'listPatients'))
      ...
      facilityId,
      qParams.last_consultation_assigned_to_mbbs_student,
    ...
    <div className="px-6">
      ...
      <div className="mt-5 md:grid grid-cols-1 gap-5 sm:grid-cols-3 my-4 px-2 md:px-0 relative">
        ...
        <div className="flex space-x-2 mt-2 flex-wrap w-full col-span-3 space-y-1">
          ...
          {badge("MBBS Student", qParams.last_consultation_assigned_to_mbbs_student)}
          {
            qParams.is_vaccinated && (
